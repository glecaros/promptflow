...
class TestSummary:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                (
                    "This is a long text that is definitely more than 100 characters. "
                    "It's used for testing the truncation function in our code."
                ),
                "This is a long text that is definitely more than 100 characters. It's used for testing the truncatio",
            ],
        ...
        [
            ...
            [
                [
                    ...
                    {
                        "name": "promptflow.function.output",
                        "attributes": {"payload": '{"test": "output"}'},
                    },
                ],
                "show first input",
                "show first output",
